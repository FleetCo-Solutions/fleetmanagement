...
const Trips = () => {
  ...
  const avgDuration = totalTrips > 0 ? Math.round(trips.reduce((sum, t) => sum + t.duration, 0) / totalTrips) : 0;

  return (
    <div className="bg-white w-full h-full flex items-center justify-center">
      <div className="w-[96%] h-[96%] flex flex-col gap-6">
        <div className="flex justify-between items-center">
          <h1 className="text-3xl font-bold text-black">Trips Management</h1>
        </div>
        {/* Summary Cards */}
        ...
        <div className="flex justify-between gap-6">
          ...
          <OverviewRealTime
            ...
            quantity={`${totalFuel.toLocaleString()} L`}
            description="All trips"
          />
