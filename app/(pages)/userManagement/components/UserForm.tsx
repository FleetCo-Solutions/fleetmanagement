          ...
          <div key={field.id} className="border border-gray-200 rounded-lg p-4 mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <input
                  {...control.register(`emergencyContacts.${index}.firstName`, { required: "First name is required" })}
                  type="text"
              ...
              <div>
                ...
                <input
                  {...control.register(`emergencyContacts.${index}.lastName`, { required: "Last name is required" })}
                  type="text"
                  className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#004953] ${
              ...
              <div>
                ...
                <input
                  {...control.register(`emergencyContacts.${index}.relationship`, { required: "Relationship is required" })}
                  type="text"
                  className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#004953] ${
              ...
              <div>
                ...
                <input
                  {...control.register(`emergencyContacts.${index}.address`, { required: "Address is required" })}
                  type="text"
                  className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#004953] ${
