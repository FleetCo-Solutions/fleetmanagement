...
=======
import manufacturersData from "@/data/Car Manufacturers.json";
>>>>>>> Stashed changes
...
const mockDevices = [
  { brand: "Teltonika", model: "FMB120", imei: "860123456789012" },
  { brand: "Teltonika", model: "FMC130", imei: "860123456789013" },
  { brand: "Queclink", model: "GV300", imei: "860123456789014" },
  { brand: "Ruptela", model: "HCV5", imei: "860123456789015" },
];
...
=======
  ...
  // Create a display-only Asset ID that matches the backend logic
  const [displayAssetId] = React.useState(() => `AST-${new Date().getFullYear()}-XXXXX`);
>>>>>>> Stashed changes
...
=======
      try{
        const cleanedData: IPostVehicle = {
          ...
          flespiIdent: data.flespiIdent?.trim(),
          simSerialNumber: data.simSerialNumber?.trim(),
        };
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 text-black/80">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {/* Asset ID (Autogenerated - Info only) */}
        <div className="space-y-2">
          <label className="block text-sm font-medium text-gray-400">
            Asset ID (Autogenerated)
          </label>
          <div className="w-full px-3 py-2 border border-gray-200 bg-gray-50 rounded-md text-gray-500 font-mono">
            {displayAssetId}
          </div>
        </div>
        ...
        <div className="space-y-2">
          ...
          <Controller
            ...
            render={({ field }) => (
              <select
                {...field}
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#004953] focus:border-transparent appearance-none bg-white"
              >
        ...
        <div className="space-y-2">
          ...
          <Controller
            name="odometer"
            control={control}
            rules={{ required: "Current odometer reading is required" }}
            render={({ field }) => (
              <input
                {...field}
                type="number"
          ...
          />
          {errors.odometer && (
            <p className="text-red-500 text-sm">{errors.odometer.message}</p>
          )}
        </div>
        ...
        <div className="space-y-2">
          ...
          <Controller
            ...
            rules={{
              ...
              validate: (value) => value.length === 17 || "VIN must be exactly 17 characters",
            }}
            render={({ field }) => (
              <input
                {...field}
                type="text"
                maxLength={17}
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#004953] focus:border-transparent font-mono text-sm"
        ...
        {/* Mobile Device Settings Section */}
        <div className="md:col-span-2 pt-4">
          <h3 className="text-sm font-bold text-[#004953] uppercase tracking-wider mb-4 border-b border-gray-100 pb-2">
              ...
              <Controller
                ...
                render={({ field }) => (
                  <input
                    ...
                    type="text"
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#004953] focus:border-transparent"
                    placeholder="SIM Card Serial / ICCID"
                  />
                )}
              />
            </div>
...
=======
          type="submit"
          className="px-4 py-2 text-sm font-medium text-white bg-[#004953] border border-transparent rounded-md hover:bg-[#014852] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#004953]"
        >
          Create Vehicle
>>>>>>> Stashed changes
        </button>
