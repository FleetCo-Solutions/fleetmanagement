...
const DriverViolationsTab: React.FC<DriverViolationsTabProps> = ({
  isLoading,
  violations = [],
}) => {
      ...
      },
      {
        ...
        cell: (info) => (
          <span className="text-gray-600">
            {new Date(info.getValue() as string | Date).toLocaleString("en-GB")}
          </span>
        ),
      },
      {
...
export default DriverViolationsTab;
